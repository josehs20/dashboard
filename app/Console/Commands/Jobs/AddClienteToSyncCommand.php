...
use App\Jobs\AddClienteToSyncJob;
use Illuminate\Support\Facades\Storage;
use App\Models\Empresa;

class AddClienteToSyncCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'add-job:cliente';
        ...
        foreach ($empresas as $empresa) {
            ...
            foreach ($files as $file) {
                if ($this->filePermited($empresa, $file)) {
                    ...
                    $job = (new AddClienteToSyncJob($empresa, $file))->delay(now()->addSeconds(3));
    ...
    {
        return (str_contains($file, '-CLIENTE-') and $empresa->arquivos()->where('nome', $file)->count() == 0);
    }
}
